...
public class ClntEventEmb implements java.io.Serializable{
	private static final long serialVersionUID = 5454155825314635342L;
	
	//alias
	public static final String TABLE_ALIAS = "挤占挪用贷款情况";
	public static final String ALIAS_ID = "id";
	public static final String ALIAS_CLNTNO = "客户号";
	public static final String ALIAS_HPPNDATE = "发生日期";
	public static final String ALIAS_EMBAMNT = "挪用金额";
	public static final String ALIAS_EVENTDESC = "事件描述";
	...
	/**挪用金额==>db_column: EMBAMNT*/
	private BigDecimal embamnt;
	...
	public BigDecimal getEmbamnt() {
		return embamnt;
	}

	public void setEmbamnt(BigDecimal embamnt) {
		this.embamnt = embamnt;
	}
	...
	public boolean equals(Object obj) {
		if(obj instanceof ClntEventEmb == false) return false;
		if(this == obj) return true;
		ClntEventEmb other = (ClntEventEmb)obj;
