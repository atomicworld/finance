...
@XStreamAlias("SMS")
public class SmsResponse implements ObjectEncoder
{
	...
	public static Object parseXml(byte[] bytes) 
	{
		xStream.processAnnotations(SmsResponse.class);
